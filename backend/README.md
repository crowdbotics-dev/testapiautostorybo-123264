...
## Project Structure
    ...
    ├── testapiautostorybo_123264  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_123264`
...
2. Clone this repo and `cd testapiautostorybo_123264`
